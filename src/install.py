...
try:
	...
	os.system("python -m pip install --upgrade kivy==2.0.0")
	...
	os.system("python -m pip install kivy_deps.gstreamer==0.1.*")
	os.system("python -m pip install kivy_deps.angle==0.1.*")
	os.system("python -m pip install kivy==2.0.0")

try:
    import cv2
    currentInstall = "Upgrading OpenCV"
    os.system("python -m pip install --upgrade opencv-python==4.5.2.*")
except Exception:
    currentInstall = "Installing OpenCV"
    os.system("python -m pip install opencv-python==4.5.2.*")
...
try:
    ...
    os.system("python -m pip install --upgrade numpy==1.20.1")
except Exception:
    currentInstall = "Installing NumPy"
    os.system("python -m pip install numpy==1.20.1")
...
try:
    ...
    os.system("python -m pip install --upgrade scipy==1.6.0")
except Exception:
    currentInstall = "Installing Scipy"
    os.system("python -m pip install scipy==1.6.0")
...
try:
    import scipy
    currentInstall = "Upgrading Pillow"
    os.system("python -m pip install --upgrade Pillow==8.2.0")
except Exception:
    currentInstall = "Installing Pillow"
    os.system("python -m pip install Pillow==8.2.0")
